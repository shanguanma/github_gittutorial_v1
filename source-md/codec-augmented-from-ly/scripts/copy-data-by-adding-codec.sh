...
nj=40
do_clean=false
utt_prefix="codec-good-"
spk_prefix="codec-good-"
# end option
...
--utt-prefix $utt_prefix --spk-prefix $spk_prefix \
...
if [ ! -z $step01 ]; then
  ./scripts/copy_data_dir.sh --utt-prefix $utt_prefix --spk-prefix $spk_prefix \
  $source_data $tmpdir 
fi
