...
def main():
  ...
  with common_lib.smart_open(args.kaldi_text, 'w') as kaldi_text_writer:
    for record_id in kaldi_text_scp.keys():
      ...
      print("{0} {1}".format(record_id, line), file=kaldi_text_writer) 
...
# source-md/egs/asru2019/make_text_for_dev_new.py  run_1b/data/dev_new/text_1_scp run_1b/data/dev_new/text_2
