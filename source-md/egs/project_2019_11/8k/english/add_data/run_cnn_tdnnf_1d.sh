...
set -e
. cmd.sh
cmd="slurm.pl --quiet --exclude=node08,node07"
...
train_ivector_dir=data/nnet3_ubs2020_only_ubs_cs/ivectors_${ivector_train_set}_hires     #  train set 100 dim ivector folder
...
if [ $stage -le 5 ];then
   ...
   steps/nnet3/chain/train.py --stage $train_stage \
    --cmd "slurm.pl --quiet --exclude=node01,node02,node03,node04,node06,node05" \
