...
if [ ! -z $step01 ]; then
  ...
  # make wav.scp
  cat ${train_data}/tmp_segments | source-md/egs/project_2019_11/8k/english/add_data/codec/rewrite-wav-scp.pl \
  ...
  # clean grabage file
  rm ${train_data}/tmp_segments ${train_data}/tmp_wav.scp 
