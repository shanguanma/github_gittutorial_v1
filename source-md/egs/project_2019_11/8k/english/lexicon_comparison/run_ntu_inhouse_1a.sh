...
# run_ntu_inhouse_1a.sh is same as run_imda_1a.sh ,I only used NTU in-house Lexicon to replace IMDA Lexicon 
# lexicon: NTU in-house Lexicon:
# /home4/hhx502/w2019/projects/nov03_sge8k/exp/data/local/dict/dict_ntu_inhouse
...
src_dict_dir=/home4/hhx502/w2019/projects/nov03_sge8k/exp/data/local/dict/dict_ntu_inhouse
tgtdir=run_ntu_inhouse_1a
...
#prepare lang .
###############################################################################
dictdir=$datadir/dict_ntu_inhouse
lang=$datadir/lang
if [ ! -z $step02 ]; then
...
# [md510@node06 lexicon_comparison]$ cat run_ntu_inhouse_1a/exp/tri4/decode_dev_imda_part3_ivr/scoring_kaldi/best_wer 
# %WER 43.28 [ 80310 / 185558, 13712 ins, 15553 del, 51045 sub ] run_ntu_inhouse_1a/exp/tri4/decode_dev_imda_part3_ivr/wer_13_1.0
# cat run_ntu_inhouse_1a/exp/tri4/decode_wiz3ktest/scoring_kaldi/best_wer 
# %WER 91.36 [ 15714 / 17200, 638 ins, 7195 del, 7881 sub ] run_ntu_inhouse_1a/exp/tri4/decode_wiz3ktest/wer_15_1.0
...
# [md510@node06 lexicon_comparison]$ cat run_ntu_inhouse_1a/exp/tri3/decode_dev_imda_part3_ivr/scoring_kaldi/best_wer 
# %WER 48.54 [ 90072 / 185558, 12761 ins, 18950 del, 58361 sub ] run_ntu_inhouse_1a/exp/tri3/decode_dev_imda_part3_ivr/wer_14_1.0
# [md510@node06 lexicon_comparison]$ cat run_ntu_inhouse_1a/exp/tri3/decode_wiz3ktest/scoring_kaldi/best_wer 
# %WER 88.99 [ 15306 / 17200, 666 ins, 6608 del, 8032 sub ] run_ntu_inhouse_1a/exp/tri3/decode_wiz3ktest/wer_16_1.0
