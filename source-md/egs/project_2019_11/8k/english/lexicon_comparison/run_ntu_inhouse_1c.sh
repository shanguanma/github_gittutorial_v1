...
# 1c is same as 1b
# I use a new dictionary , it comes from the dictionary, 
# the details of the dictionary is writen at readme.txt in the path(e.g:run_ntu_inhouse_1c/data/dict_ntu_inhouse_new) 
...
#prepare lang .
###############################################################################
dictdir=$datadir/dict_ntu_inhouse_new
lang=$datadir/lang
if [ ! -z $step02 ]; then
...
# cat run_ntu_inhouse_1c/exp/tri4/decode_wiz3ktest/scoring_kaldi/best_wer 
# %WER 91.43 [ 15726 / 17200, 435 ins, 7586 del, 7705 sub ] run_ntu_inhouse_1c/exp/tri4/decode_wiz3ktest/wer_17_1.0
# [md510@node06 lexicon_comparison]$ cat run_ntu_inhouse_1c/exp/tri4/decode_dev_imda_part3_ivr/scoring_kaldi/best_wer 
# %WER 42.58 [ 79016 / 185558, 13286 ins, 15445 del, 50285 sub ] run_ntu_inhouse_1c/exp/tri4/decode_dev_imda_part3_ivr/wer_15_0.5
fi
...
#  cat run_ntu_inhouse_1c/exp/tri3/decode_dev_imda_part3_ivr/scoring_kaldi/best_wer 
# %WER 48.24 [ 89514 / 185558, 13042 ins, 18575 del, 57897 sub ] run_ntu_inhouse_1c/exp/tri3/decode_dev_imda_part3_ivr/wer_13_1.0
# [md510@node06 lexicon_comparison]$ cat run_ntu_inhouse_1c/exp/tri3/decode_wiz3ktest/scoring_kaldi/best_wer 
# %WER 89.30 [ 15359 / 17200, 672 ins, 6273 del, 8414 sub ] run_ntu_inhouse_1c/exp/tri3/decode_wiz3ktest/wer_14_1.0
...
# However, it cannot be directly copied to the corresponding directory of run_ntu_inhouse_1c. 
