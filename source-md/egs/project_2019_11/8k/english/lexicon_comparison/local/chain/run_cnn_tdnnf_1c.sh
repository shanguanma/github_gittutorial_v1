...
test_set_2=
test_set_3=
train_data_dir=         # no speed and volume perturbation train data
lores_train_data_dir=   # # speed disturbed data  13 dim mfcc 
train_data_sp_hires_dir= # speed and volume disturbed data  40 dim mfcc 
