...
test_set_2=
test_set_3=
train_data_dir=data/train_imda_part3_ivr_msf_i2r_imda_boundarymic_codec_ubs2020_train         # no speed and volume perturbation train data
lores_train_data_dir=data/train_imda_part3_ivr_msf_i2r_sp_imda_boundarymic_codec_ubs2020_train   # # speed disturbed data  13 dim mfcc 
train_data_sp_hires_dir=data/train_imda_part3_ivr_msf_i2r_sp_imda_boundarymic_codec_ubs2020_train_hires  # speed and volume disturbed data  40 dim mfcc 
train_ivector_dir=data/nnet3_ubs2022_english/ivectors_data/train_imda_part3_ivr_msf_i2r_sp_imda_boundarymic_codec_ubs2020_train_hires     #  train set 100 dim ivector folder

test_set_dir=data         # test set 40 dim mfcc feature path
test_set_ivector_dir=data/nnet3_ubs2022_english # test set 100 dim ivector feature path
