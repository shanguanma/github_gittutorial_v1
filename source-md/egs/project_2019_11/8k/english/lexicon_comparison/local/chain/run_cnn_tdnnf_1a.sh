...
train_data_dir=$tgtdir/data/${train_set}_sp_hires           # seep and volume disturbed data 
...
train_ivector_dir=$tgtdir/exp/nnet3${nnet3_affix}/ivectors_${train_set}_sp_hires # 
 ...
 if $pp ;then
  ...
  for decode_set in $test_set_1 $test_set_2; do
      ...
      steps/nnet3/decode.sh --acwt 1.0 --post-decode-acwt 10.0 \
          ...
          --online-ivector-dir $tgtdir/exp/nnet3/ivectors_${decode_set}_hires \
          $graph_dir $tgtdir/data/${decode_set}_hires \
