...
data_dir=exp/segmentation_$affix/train_whole_hires
targets_dir=exp/segmentation_$affix/train_whole_combined_targets_sub3
...
#if [ -z "$dir" ]; then
#  dir=exp/segmentation_$affix/tdnn_lstm_asr_sad
#fi
