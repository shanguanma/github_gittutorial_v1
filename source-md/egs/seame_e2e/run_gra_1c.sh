...
## but I randomly select 1/3 from sp as final train set.
...
if [ ! -z $step03 ]; then
     ...
     utils/combine_data.sh --extra-files utt2uniq ${tgtdir}/data/train_trn_sp ${tgtdir}/data/temp1 ${tgtdir}/data/temp2 ${tgtdir}/data/temp3
     ...
     steps/make_fbank_pitch.sh --cmd "$train_cmd" --nj 50 --write_utt2num_frames true \
        ${tgtdir}/data/train_trn_sp ${tgtdir}/exp/make_fbank/train_trn_sp ${tgtdir}/${fbankdir}
     utils/fix_data_dir.sh ${tgtdir}/data/train_trn_sp
     #  I randomly select 1/3 from sp as final train set now.
     # now  ${tgtdir}/data/${train_set} has 253043 utts
     # I random select 1/3 * 253043 = 84347.7
     utils/subset_data_dir.sh   ${tgtdir}/data/train_trn_sp 84348  ${tgtdir}/data/${train_set}    
     echo "LOG:::get 1/3 speed-perturbed for train_trn set done"
fi
