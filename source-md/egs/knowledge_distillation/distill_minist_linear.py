...
class Net(nn.Module):
    def __init__(self):
        ...
        self.fc1 = torch.nn.Linear(28*28, 800)
...
teacher_model.load_state_dict(torch.load('teacher_mnist_linear.pt')) 
...
if args.save_model:
    torch.save(model.state_dict(), 'distillation_mnist_linear.pt')
