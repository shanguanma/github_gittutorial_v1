...
src_train_data_dir=data/model_8ch_sub/
src_test_data_dir=data/dev
train_set=model_8ch_sub_merge                  # train set name
...
tgtdir=train_data_8ch_sub_new       #  root folder of the entire asr system 
suffix="_8ch"               # you can set it, then run different model in same tgtdir,
