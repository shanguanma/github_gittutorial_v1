...
train_set=data_sub_Hch                  # train set name
...
tgtdir=train_data_Hch_sub_new       #  root folder of the entire asr system 
suffix="_Hch"               # you can set it, then run different model in same tgtdir,
