...
train_set=data_src                  # train set name
...
tgtdir=train_data_src_new       #  root folder of the entire asr system 
suffix="_src"               # you can set it, then run different model in same tgtdir,
