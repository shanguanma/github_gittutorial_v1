...
train_set=data_sub_Cch                  # train set name
...
tgtdir=train_data_Cch_sub_new       #  root folder of the entire asr system 
suffix="_Cch"               # you can set it, then run different model in same tgtdir,
