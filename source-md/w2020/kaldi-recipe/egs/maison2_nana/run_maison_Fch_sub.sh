...
train_set=data_sub_Fch                  # train set name
...
tgtdir=train_data_Fch_sub_new       #  root folder of the entire asr system 
suffix="_Fch"               # you can set it, then run different model in same tgtdir,
