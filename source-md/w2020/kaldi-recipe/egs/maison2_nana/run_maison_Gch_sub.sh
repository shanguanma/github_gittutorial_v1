...
train_set=data_sub_Gch                  # train set name
...
tgtdir=train_data_Gch_sub_new       #  root folder of the entire asr system 
suffix="_Gch"               # you can set it, then run different model in same tgtdir,
