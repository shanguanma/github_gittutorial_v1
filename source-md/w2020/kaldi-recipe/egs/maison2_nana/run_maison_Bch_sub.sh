...
train_set=data_sub_Bch                  # train set name
...
tgtdir=train_data_Bch_sub_new       #  root folder of the entire asr system 
suffix="_Bch"               # you can set it, then run different model in same tgtdir,
