...
train_set=data_sub_Ach                  # train set name
...
tgtdir=train_data_Ach_sub_new       #  root folder of the entire asr system 
suffix="_Ach"               # you can set it, then run different model in same tgtdir,
