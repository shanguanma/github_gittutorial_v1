...
echo " ##### start to get utt2dur file ..."
/home4/md510/package/source-md/asr_frontend/data_level/codec/get_utt2dur.sh ${srcdir}
echo " ##### start to get reco2dur file ..."
#/home4/md510/package/source-md/asr_frontend/data_level/codec/get_reco2dur.sh ${srcdir
cp ${srcdir}/utt2dur ${srcdir}/reco2dur
