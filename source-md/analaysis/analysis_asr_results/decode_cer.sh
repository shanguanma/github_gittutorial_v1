...
# using cer  for code-switch
if [ $stage -le 3 ]; then
    source-md/analaysis/analysis_asr_results/scoring_character/score_kaldi_code-switching_cer.sh \
        $scoring_opts --cmd "$cmd" $data $graphdir $dir
fi
echo "Decoding done."
exit 0;
