...
def get_parse():
    parser = argparse.ArgumentParser(
        description="select part lexicon from big"
        "lexicon by specifying wordlist file")
    parser.add_argument("--trainset_en_text",
                        type=str,
                        required=True,
                        help="kaldi format" 
                        "text file of train set,"
                        "it should be english word text")
    parser.add_argument("--big_lexicon",
                        type=str,
                        required=True,
                        help="kaldi required pronunciton lexicon.txt"
                        "file")
