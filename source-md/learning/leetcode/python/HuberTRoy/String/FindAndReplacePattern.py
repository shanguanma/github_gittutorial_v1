...
判断是否与给定的字符串模式是一样的。
"""
# method 1 The process is not clear  
class Solution(object):
    def findAndReplacePattern(self, words, pattern):
        ...
        """
        #return [wd for wd in words if map(wd.index, wd) == map(pattern.index, pattern)]
...
#out = findAndReplacePattern(words, pattern)
#print(out)
# how to call a pure class? 
class Knight(object):
