...
def get_train_times(exp_dir):
    ...
    train_log_names = "train.*.*.log"  # md change "train.*.log" to "train.*.*.log" 
...
def main():
    parser = argparse.ArgumentParser(description='generate accuracy log probability report Wrapper')
    parser.add_argument('exp_dir', type=str, help='store train model log file directory')
    args = parser.parse_args()
    print(args)
    generate_acc_logprob_report(args.exp_dir, "log-probability") 
